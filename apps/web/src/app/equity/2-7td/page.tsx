...
// ============================================================================
// 2-7 Triple Draw Hand Evaluator (client-side)
// ============================================================================
...
// We evaluate the best 5-card hand from the 5 hole cards (no board in draw poker)
// Hand categories (best to worst):
//   1. Straight flush (not possible in 2-7 with 5 cards? Actually yes: 5-4-3-2-A same suit)
//   2. Four of a kind
//   3. Full house
//   4. Flush
//   5. Straight
...
//   8. One pair
//   9. High card
// In 2-7, straights and flushes COUNT AGAINST you (they are bad).
// A-2-3-4-5 (wheel) is the WORST straight (it's a 5-high straight, which is bad in 2-7).
// The best possible hand is 7-5-4-3-2 (unsuited, unpaired, no straight).
...
function evaluateHand(cards: Card[]): HandRank {
  ...
  if (uniqueValues.length === 5) {
    ...
    // Wheel: A-2-3-4-5 (values are 1,2,3,4,5)
  ...
  // In 2-7:
  // Best hand: no pair, no flush, no straight, with 7-5-4-3-2 being ideal
  // Category 0: High card (no pair, no flush, no straight) — BEST
  // Category 1: One pair
  // Category 2: Two pair
  // Category 3: Three of a kind
  // Category 4: Straight (counts against)
  // Category 5: Flush (counts against)
  // Category 6: Full house
  // Category 7: Four of a kind
  // Category 8: Straight flush — WORST
  ...
  if (isFlush) {
    // Sort values descending for tiebreaker
...
function calculateEquity(
  ...
  for (let i = 0; i < samples; i++) {
    ...
    // Deal 5 cards to each hand (draw phase — no discarding for simplicity)
...
export default function DeuceToSevenTripleDrawPage() {
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-poker-gold mb-1">
            2-7 Triple Draw Equity
          </h1>
          <p className="text-gray-400 text-sm">
            Deuce-to-Seven Triple Draw equity calculator — enter two 5-card hands and compare.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-400">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-0.5 text-xs">
                <li>Each player gets 5 cards, then 3 draw rounds</li>
